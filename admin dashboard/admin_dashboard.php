    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="http://localhost:8008/placement management system/admin dashboard/admin_post_announcement.html">Announce</a></li>
                <li><a href="http://localhost:8008/placement management system/admin dashboard/announcement_show.php">Circular</a></li>
                <li><a href="http://localhost:8008/placement management system/companyregisteration/admindashboard.php">Activate Company</a></li>
        ...
        <div class="content">
            ...
            <div id="registration" class="section" style="display:none;">
                ...
                <?php include 'registrationlist.php'; ?>
            </div>
